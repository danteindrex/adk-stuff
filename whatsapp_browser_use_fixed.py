...
Fixed implementation for Uganda E-Gov Helpdesk
"""
...
"""
            ...
            # Run with explicit max_steps parameter
            result = await self.agent.run(auth_task, max_steps=15)
...
"""
            ...
            result = await self.agent.run(send_task, max_steps=12)
...
"""
            ...
            result = await self.agent.run(check_task, max_steps=10)
